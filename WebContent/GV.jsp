...
<body>
	...
	<a href="LoadExelForward">hahaha</a>
					...
					<div class="row">
						...
						<div class="col-sm-9 content-exam">
							<div>
								...
								<form action="LoadExelForward">
									<input type="file" name="namefile" accept="application/vnd.openxmlformats-officedocument.spreadsheetml.sheet, application/vnd.ms-excel" style="margin-top: 10px;" />
									<input type="submit" class="btnExam buttonExam"  onclick="showExam()" value="Lưu" >
									<!--<button href="LoadExamFromExelFơward" class="btnExam buttonExam" onclick="showExam()">Lưu</button>-->
								</form>
